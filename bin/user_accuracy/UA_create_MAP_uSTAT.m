...
% vals = struct(  'username',usernames','weight',num2cell(weight'),'nv',num2cell(UA.nv'),'hot',num2cell(UA.hot'), ...
% 				'n_seg',num2cell(UA.tp + UA.fn + UA.fp + UA.tn)', ...
% 				'tp',num2cell(UA.tp'),'fn',num2cell(UA.fn'),'fp',num2cell(UA.fp'),'tn',num2cell(UA.tn'), ...
% 				'n_voxels',num2cell(UA.tpv + UA.fnv + UA.fpv + UA.tnv)', ...
% 				'tpv',num2cell(UA.tpv)','fnv',num2cell(UA.fnv)','fpv',num2cell(UA.fpv)','tnv',num2cell(UA.tnv)', ...
% 				's_prec',num2cell(s_prec)','s_rec',num2cell(s_rec)','s_fs',num2cell(s_fs)', ...
% 				'v_prec',num2cell(v_prec)','v_rec',num2cell(v_rec)','v_fs',num2cell(v_fs)', ...
% 				's_p1',num2cell(s_p1'),'s_p0',num2cell(s_p0'),'s_a',num2cell(s_a'),'s_b',num2cell(s_b'), ...
% 				'v_p1',num2cell(v_p1)','v_p0',num2cell(v_p0)','v_a',num2cell(v_a)','v_b',num2cell(v_b)' ...
% 			 );
